...
for i=1:length(t)
    ...
    k=1;
    while(norm([f1; f2; f3],2)>1e-12) %norm(lk,2) = norm(lk)
       % Jacobian
        J=zeros(3,3);
    ...
    dJq(1,2)= -l3*cos(q2(i)+q3(i))*(dq2(i)+dq3(i))*cos(q1(i))+l3*sin(q2(i)+q3(i))*sin(q1(i))*dq1(i)+l2*sin(q1(i))*dq1(i)*sin(q2(i))-l2*cos(q1(i))*cos(q2(i))*dq2(i);
    ...
    dJq(2,2)= -l3*cos(q2(i)+q3(i))*(dq2(i)+dq3(i))*sin(q1(i)) - l3*sin(q2(i)+q3(i))*cos(q1(i))*dq1(i) - l2*cos(q1(i))*dq1(i)*sin(q2(i))-l2*sin(q1(i))*cos(q2(i))*dq2(i);
    dJq(2,3)= -l3*cos(q2(i)+q3(i))*(dq2(i)+dq3(i))*sin(q1(i)) - l3*sin(q2(i)+q3(i))*cos(q1(i))*dq1(i);

    dJq(3,1)=0;
    dJq(3,2)= -l3*sin(q2(i)+q3(i))*(dq2(i)+dq3(i))-l2*sin(q2(i))*dq2(i);
    ...
    % Ma tran Cq
    Cq = zeros(3,3);
    Cq(1,1) = (-0.1*cos(q2(i))*sin(q2(i))+0.1e-1*sin(q2(i))-0.2e-1*cos(q2(i)+q3(i))*sin(q2(i)+q3(i))+0.3e-2*sin(q2(i)+q3(i))-0.2e-1*sin(q2(i)+q3(i))*cos(q2(i))-0.2e-1*cos(q2(i)+q3(i))*sin(q2(i)))*dq2(i)-0.2e-1*sin(q2(i)+q3(i))*(cos(q2(i)+q3(i))-0.2+cos(q2(i)))*dq3(i);
    Cq(1,2) = -0.4e-2*cos(q1(i))*sin(q1(i))*dq3(i);
    Cq(1,3) = -0.4e-2*cos(q1(i))*sin(q1(i))*dq2(i)-0.4e-2*cos(q1(i))*sin(q1(i))*dq3(i);

    Cq(2,1) = -(0.5*(-0.1*cos(q2(i))*sin(q2(i))+0.1e-1*sin(q2(i))-0.2e-1*cos(q2(i)+q3(i))*sin(q2(i)+q3(i))+0.3e-2*sin(q2(i)+q3(i))-0.2e-1*sin(q2(i)+q3(i))*cos(q2(i))-0.2e-1*cos(q2(i)+q3(i))*sin(q2(i))))*dq1(i);
    Cq(2,2) = (0.2e-1*cos(q2(i)+q3(i))*sin(q2(i))-0.2e-1*sin(q2(i)+q3(i))*cos(q2(i)))*dq3(i);
    Cq(2,3) = 0.8e-2*cos(q1(i))*sin(q1(i))*dq1(i)+(0.9e-2*cos(q2(i)+q3(i))*sin(q2(i))-0.9e-2*sin(q2(i)+q3(i))*cos(q2(i)))*dq3(i);

    Cq(3,1) = 0.1e-1*sin(q2(i)+q3(i))*(cos(q2(i)+q3(i))-0.2+cos(q2(i)))*dq1(i);
    Cq(3,2) = 0.8e-2*cos(q1(i))*sin(q1(i))*dq1(i)+(0.8e-2*cos(q2(i)+q3(i))*sin(q2(i))-0.8e-2*sin(q2(i)+q3(i))*cos(q2(i)))*dq3(i)-(0.5*(0.2e-1*cos(q2(i)+q3(i))*sin(q2(i))-0.2e-1*sin(q2(i)+q3(i))*cos(q2(i))))*dq2(i)-(0.5*(0.9e-2*cos(q2(i)+q3(i))*sin(q2(i))-0.9e-2*sin(q2(i)+q3(i))*cos(q2(i))))*dq3(i);
    Cq(3,3) = 0.8e-2*cos(q1(i))*sin(q1(i))*dq1(i)-(0.5*(0.8e-2*cos(q2(i)+q3(i))*sin(q2(i))-0.8e-2*sin(q2(i)+q3(i))*cos(q2(i))))*dq2(i);
    
    %ma tran Mq
    Mq = zeros(3,3);
    Mq(1,1) = 0.147e-2+0.52e-1*cos(q2(i))^2-0.135e-1*cos(q2(i))+0.1e-1*cos(q2(i)+q3(i))^2-0.3e-2*cos(q2(i)+q3(i))+0.2e-1*cos(q2(i)+q3(i))*cos(q2(i));
    Mq(1,2) = 0;
    Mq(1,3) = 0;

    Mq(2,1) = 0;
    Mq(2,2) = 0.62e-1+0.2e-1*sin(q2(i)+q3(i))*sin(q2(i))+0.2e-1*cos(q2(i)+q3(i))*cos(q2(i));
    Mq(2,3) = 0.1e-1-0.4e-2*cos(q1(i))^2+0.9e-2*sin(q2(i)+q3(i))*sin(q2(i))+0.9e-2*cos(q2(i)+q3(i))*cos(q2(i));

    Mq(3,1) = 0;
    Mq(3,2) = 0.1e-1-0.4e-2*cos(q1(i))^2+0.8e-2*sin(q2(i)+q3(i))*sin(q2(i))+0.8e-2*cos(q2(i)+q3(i))*cos(q2(i));
    Mq(3,3) = 0.1e-1-0.4e-2*cos(q1(i))^2;
    
    %ma tran Gq
    Gq = zeros(3,1);
    Gq(1,1) = 0;
    Gq(2,1) = 1.9*cos(q2(i))+0.41*cos(q2(i)+q3(i));
    Gq(3,1) = 0.41*cos(q2(i)+q3(i));
